...
public class OrderDaoTest {
    ...
    public void testAddGetOrder() throws Exception {
        ...
        Order fromDao = dao.getOrder(order.getOrderNum(), order.getDate());
    ...
    public void testEditOrder() throws Exception {
        ...
        dao.editOrder(fromDao.getOrderNum(), fromDao);
    ...
    public void testRemoveOrder() throws Exception {
        ...
        assertNull(dao.getOrder(order1.getOrderNum(), order1.getDate()));
        
        dao.removeOrder(order2.getOrderNum());
        assertEquals(0, dao.getAllOrders().size());
        assertNull(dao.getOrder(order2.getOrderNum(), order2.getDate()));
    }
